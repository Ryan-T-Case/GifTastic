...
var topics = ["Tom Brady", "Aaron Rodgers", "Cam Newton", "Odell Beckham Jr", "Ezekiel Elliott", "JJ Watt", "Richard Sherman", "Travis Kelce"];
...
$(document).ready(function () {
    ...
    $(document).on('click', ".gifButton", function () {
        ...
        var queryUrl = "https://api.giphy.com/v1/gifs/search?q=" + playerName + "&limit=10&rating=pg&api_key=rtgthQjEoOhWYW3RTQOxmXNysTIY2THi";
